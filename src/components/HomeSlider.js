    ...
    <Fragment>
      ...
      >
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-20">உழவின் பெருமை</div>
                <h3>பரம்பு ஓட்டுதல், பார் ஓட்டுதல், பாத்தி ஓட்டுதல்</h3>
                <h6>பருத்தி, கரும்பு, சோளம், மரவள்ளிக்கிழங்கு, மஞ்சள், எள், கடலை</h6>
                <div className="slider-btns mt-30">
                  <Link href="/shop">
                    <a className="theme-btn style-two">
                      தயாரிப்புகளைப் ஆராய்க <i className="fas fa-angle-double-right" />
                    </a>
                  </Link>
                  <Link href="/about-us">
                    <a className="theme-btn style-two">
            ...
            <div className="col-lg-6">
              <div className="slider-images">
                ...
                <img
                  ...
                  alt="உயிரியல் உலர்ந்த அத்தியாவசியங்கள்"
                />
              </div>
            </div>
          </div>
        ...
        <div className="slide-shapes">
          ...
          <img
            className="two-leaf"
            src="assets/images/slider/two-leaf.png"
            alt="இலை"
          />
          <img
            className="half-leaf"
