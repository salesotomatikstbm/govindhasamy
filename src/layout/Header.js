...
const DaskTopMenu = () => (
  <ul className="navigation clearfix d-none d-lg-flex">
    ...
    <li className="">
      <a href="/about">எங்கள் குறித்தது</a>
      <ul>
        <PagesDasktop />
      </ul>
      {/* <div className="dropdown-btn">
    ...
    <li className="">
      <a href="/blog-grid">புகைப்படங்கள்</a>
      <ul>
        <Blog />
      </ul>
      {/* <div className="dropdown-btn">
...
const DefaultHeader = () => (
  ...
  <ul>
    <li>
      <i className="far fa-envelope" /> <b>மெயில் எங்களை :</b>{" "}
      <a href="mailto:support@gmail.com">garun0890@gmail.com</a>
    </li>
    <li>
      <i className="far fa-clock" /> <b>அமைப்பார்த்த நேரம் :</b> திங்கள் - ஞாயிறு, 08 மணி - 05 மணி
    </li>
  </ul>
</div>
              ...
              <div className="top-right text-lg-right">
                <ul>
                  <li>
                    ...
                    <a href="callto:+91 98659 81850">+91 98659 81850</a>
                  </li>
                  <li>
            ...
            <div className="col-xl-7 col-lg-6">
              <div className="top-left">
                <ul>
                  ...
                  <li>
                 <span> <i className="far fa-clock" /> <b>அமைப்பார்த்த நேரம் :</b> திங்கள் - ஞாயிறு, 08 - 05 மணி  </span>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <ul>
                  ...
                  <li>
                    <div className="social-style-one">
                      ...
                      <a href="https://www.instagram.com/arun_g_it/">
                        <i className="fab fa-twitter" />
                      </a>
                      <a href="https://www.youtube.com/@Pugali_Edits">
                        <i className="fab fa-youtube" />
                      </a>
                      <a href="https://www.instagram.com/arun_g_it/">
                        <i className="fab fa-instagram" />
      ...
      <div className="container-fluid clearfix">
        <div className="header-inner d-flex align-items-center">
          ...
          <div className="menu-icons">
            ...
            <Link href="/contact">
              <a className="theme-btn">
              மேலும் தகவலுக்கு<i className="fas fa-angle-double-right" />
              </a>
            </Link>
            {/* menu sidbar */}
            <div className="menu-sidebar" onClick={() => sidebarToggle()}>
