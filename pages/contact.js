...
const ContactUs = () => {
  return (
    <Layout>
      <PageBanner pageName={"தொடர்பு கொள்ளவும்"} />
      <section className="contact-info-area rel z-1 pt-130 rpt-100">
        <div className="container">
          <div className="section-title contact-title mb-50 wow fadeInUp delay-0-2s">
            <span className="sub-title mb-15">தொடர்பு கொள்ளுங்கள்</span>
            <h3>உங்களுக்கு ஆலோசனைகள் தேவையா?</h3>
          </div>
          <div className="row">
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-4s">
                ...
                <div className="content">
                  <h4>இடம்</h4>
                  <span>தொட்டியம் அண்ணாநகர்,சின்னசேலம் வட்டம்,கள்ளக்குறிச்சி மாவட்டம்,
                  606 201.
                  </span>
                </div>
              </div>
            ...
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-5s">
                ...
                <div className="content">
                  <h4>எங்களுக்கு மின்னஞ்சல் அனுப்புங்கள்</h4>
                  <a href="mailto:organicfarm@mail.net">arungwork63@gmail.com</a>
                  <br />
                  <a href="mailto:support@info.com">garun0890@gamil.com</a>
                  <br />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-6s">
                ...
                <div className="content">
                  <h4>எங்களை அழைக்கவும்</h4>
                  <a href="callto:+91 9865981850">+91 9865981850</a>
                  <br />
                  <a href="callto:+91 6383791772">+91 6383791772</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-6">
              ...
              >
                <div className="section-title contact-title mb-55">
                  <span className="sub-title mb-15">எங்களை தொடர்பு கொள்ளுங்கள்</span>
                  <h3>எங்களுக்கு செய்தி அனுப்புங்கள்</h3>
                </div>
                <div className="row">
                  <div className="col-md-6">
                    <div className="form-group">
                      <input
                        ...
                        required=""
                        data-error="உங்கள் பெயரை உள்ளிடவும்"
                      />
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <input
                        ...
                        required=""
                        data-error="உங்கள் தொலைபேசி எண்ணை உள்ளிடவும்"
                      />
                      <div className="help-block with-errors" />
                    </div>
                  </div>
                  <div className="col-md-12">
                    <div className="form-group">
                      <input
                        ...
                        required=""
                        data-error="உங்கள் மின்னஞ்சல் முகவரியை உள்ளிடவும்"
                      />
                      <div className="help-block with-errors" />
                    </div>
                  </div>
                  <div className="col-md-12">
                    <div className="form-group">
                      <textarea
                        ...
                        required=""
                        data-error="உங்கள் செய்தியை உள்ளிடவும்"
                        defaultValue={""}
                      />
                      <div className="help-block with-errors" />
                    </div>
